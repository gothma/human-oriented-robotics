...
% CLASSIFYSVM Support Vector Machine classifier
% Input:
% 	trainingdata - x_i for all training samples
% 	testdata - y_i for all training samples
%	kernel - choice of (linear, polynomial or rbf kernel)
% 	C - stiffness parameter
% Output:
% 	C - classification results (metrics)
% 	svmmodel - struct containing support vectors and other elements
%
